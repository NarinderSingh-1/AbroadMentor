            ...
            <form class="col s12 all_form" action="" method="post" role ='form' enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <input id="event_name" type="text" class="validate" name="name" value="{{isset($event['name']) ? $event['name'] : ''}}">
                        <label for="event_name"  data-error="wrong" data-success="right">Event Name (maximum 200 characters)*</label>
                    </div>

                    <div class="input-field col s12">
                        <input type="text" name="category" class="location" id="categoryAutoComplete" value="{{isset($event['category']) ? $event['category'] : ''}}" autocomplete="off" />
                        <label for="event_categoty" data-error="wrong" data-success="right">Event Category*</label>
                    </div>

                    <div class="input-field col s12">
                        <textarea id="event" class="materialize-textarea" name="introduction">{{isset($event['introduction']) ? $event['introduction'] : ''}}</textarea>
                        ...
                        @if(!empty($collageList))
                            ...
                            <div class="collage">
                                <div class="input-field col s12 m6">
                                    <input id="uni_name" type="text" class="validate" name="others[degree][collage][]" value="{{ $collage['collage'] }}">
                                ...
                                <div class="input-field col s12 m6">
                                    <select name="others[degree][country][]">
                                        ...
                                        @foreach($countries as $key=>$country)
                                            <option value="{{ $key }}" {{ $collage['country_id'] == $key ? 'selected' : '' }}>{{ $country }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                    <label>Country</label>
                                ...
                                <textarea id="textarea" class="materialize-textarea" data-length="1500" name="others[degree][description][]">{{ $collage['description'] }}</textarea>
                    ...
                    <div class="input-field col s12">
                        <input type="text" class="datepicker" name="date" readonly="true" value="{{isset($event['date']) ? $event['date'] : ''}}">
                        <label for="uni_name" class="">Event Date</label>
                    </div>

                    <div class="input-field col s12 m12 l6">
                        <input type="text" class="timepicker" name="start_time" readonly="true" value="{{isset($event['start_time']) ? $event['start_time'] : ''}}">
                        <label for="uni_name" class="">Event Start Time</label>
                    </div>

                    <div class="input-field col s12 m12 l6">
                        <input type="text" class="timepicker" name="end_time" readonly="true" value="{{isset($event['end_time']) ? $event['end_time'] : ''}}">
                        <label for="uni_name" class="">Event End Time</label>
                    </div>

                    <div class="input-field col s12">
                        <input id="city" type="text" class="validate" name="city" value="{{isset($event['city']) ? $event['city'] : ''}}">
                        <label for="city"  data-error="wrong" data-success="right">City</label>
                    </div>

                    <div class="input-field col s12">
                        <input id="hotel" type="text" class="validate" name="hotel" value="{{isset($event['hotel']) ? $event['hotel'] : ''}}">

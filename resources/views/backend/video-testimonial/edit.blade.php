					...
					<form class="col s12 all_form" action="" method="post" role ='form' enctype="multipart/form-data">
						...
						<div class="row">
							<div class="input-field col s6">
                                                            <input id="video_url" type="text" class="validate" name="title" value="{{$testimonialDetail['title']}}">
								<label for="video_url" data-error="wrong" data-success="right">Title</label>
							</div>
							 <input  type="hidden" class="validate" name="id" value="{{$testimonialDetail['id']}}">
							<div class="input-field col s6">
                                                            <input id="Name" type="text" class="validate" name="name" value="{{$testimonialDetail['name']}}">
								<label for="Name" data-error="wrong" data-success="right">Candidate Name</label>
							</div>
							<div class="input-field col s6">
                                                            <input id="city" type="text" class="validate" name="city" value="{{$testimonialDetail['city']}}">
								<label for="city" data-error="wrong" data-success="right">Candidate City</label>
							</div>
                                                       
							
							<div class="input-field col s6">
                                                            <input id="video_url" type="text" class="validate" name="video_url"  value="{{$testimonialDetail['video_url']}}">

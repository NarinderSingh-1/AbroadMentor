							...
							<div class="col s12">
								...
								<div id="{{strtolower($val)}}">
									<form class="col s12 all_form" action="" method="post" role ='form' enctype="multipart/form-data">
                                                                            ...
                                                                            @if($key == $score->exam_id)
                                                                            <div class="input-field col s6">
                                                                                <input id="video_url" type="text" class="validate" name="title" value="{{isset($score->title) ? $score->title : ''}}">
                                                                                <label for="video_url" data-error="wrong" data-success="right">Title</label>
                                                                            </div>

                                                                            <div class="input-field col s6">
                                                                                <input id="Name" type="text" class="validate" name="name" value="{{isset($score->student_name) ? $score->student_name : ''}}">
                                                                                <label for="Name" data-error="wrong" data-success="right">Candidate Name</label>
                                                                            </div>

                                                                            <div class="input-field col s6">
                                                                                <input id="city" type="text" class="validate" name="city" value="{{isset($score->city) ? $score->city : ''}}">
										...
										<div class="input-field col s6">
											<input id="reading" type="number" class="validate" name="reading" value="{{isset($score->reading) ? $score->reading : ''}}"> 
											<label for="reading"  data-error="wrong" data-success="right">Reading</label>
										</div>
										
										<div class="input-field col s6">
											<input id="writing" type="number" class="validate" name="writing" value="{{isset($score->writing) ? $score->writing : ''}}">
											<label for="writing"  data-error="wrong" data-success="right">Writing</label>
										</div>
										
										<div class="input-field col s6">
											<input id="writing1" type="number" class="validate" name="listening" value="{{isset($score->listening) ? $score->listening : ''}}">
											<label for="writing1"  data-error="wrong" data-success="right">Listening</label>
										</div>
										
										<div class="input-field col s6">
											<input id="speaking" type="number" class="validate" name="speaking" value="{{isset($score->speaking) ? $score->speaking : ''}}">
											<label for="speaking"  data-error="wrong" data-success="right">Speaking</label>
										</div>
                                                                               
                                                                                
										<div class="input-field col s6">
                                                                                    <input id="overall" type="number" class="validate" name="score" value="{{isset($score->score) ? $score->score : ''}}">
